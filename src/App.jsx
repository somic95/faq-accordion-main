          ...
          <section>
            ...
            <article>
              <div className="flex justify-between" onClick={() => toggleMenu(2)}>
                <h4 className="py-5 hover:text-[#ad28eb] active:text-[#2f1533]">Can I use Frontend Mentor projects in my portfolio?</h4>
            ...
            <article>
              <div className="flex justify-between" onClick={() => toggleMenu(3)}>
                <h4 className="py-5 hover:text-[#ad28eb] active:text-[#2f1533]">How can I get help if I'm stuck on a Frontend Mentor challenge?</h4>
